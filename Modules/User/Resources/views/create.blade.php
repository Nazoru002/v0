              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control {{ $errors->has('email') ? 'is-invalid':'' }}" placeholder="Masukan E-Mail Pengguna..." value="{{ old('email') }}" required autofocus>
                    <span class="invalid-feedback">
                      {{ $errors->first('email') }}
                    </span>
                  </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control {{ $errors->has('password') ? 'is-invalid':'' }}" placeholder="Masukan Password..." value="{{ old('password') }}" required autofocus>
                    <span class="invalid-feedback">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control {{ $errors->has('password_confirmation') ? 'is-invalid':'' }}" placeholder="Tulis Ulang Password..." value="{{ old('password_confirmation') }}" required autofocus>
                    <span class="invalid-feedback">
